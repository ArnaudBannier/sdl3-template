...
#include "game/ui/game_main_page.h"
#include "game/ui/game_ui_manager.h"
#include "game/scene.h"
#include "common/ui_style.h"

static void GameMainPage_onClick(void* selectable)
{
    GameMainPage* self = (GameMainPage*)UISelectable_getUserData(selectable);
...
GameMainPage* GameMainPage_create(Scene* scene, GameUIManager *manager)
{
    ...
    GameMainPage* self = (GameMainPage*)calloc(1, sizeof(GameMainPage));
    AssertNew(self);
    ...
    for (int i = 0; i < 3; ++i)
    {
        ...
        UIButton_setOnClickCallback(button, GameMainPage_onClick);
